package this.chrisdid.alt.data.dataController.dataManagers

import this.chrisdid.alt.configuration.ALTSharedPreferences
import this.chrisdid.alt.data.dataController.callbacks.RepositoryCallbackSingle
import this.chrisdid.alt.data.dataController.dataSource.DataSource
import this.chrisdid.alt.data.response.coinSummary.SummaryCoinResponse
import this.chrisdid.alt.data.response.histoResponse.HistoricalDataResponse
import this.chrisdid.alt.data.response.marketSummary.MarketSummaryResponse
import this.chrisdid.alt.data.services.interfaces.CMCAPIService
import this.chrisdid.alt.data.services.interfaces.CryptoCompareAPIService
import this.chrisdid.alt.ui.constraintui.coinDetail.coinDetailChart.HOUR_DATA
import this.chrisdid.alt.ui.constraintui.coinDetail.coinDetailChart.MINUTE_DATA
